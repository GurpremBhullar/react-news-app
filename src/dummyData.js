export const hero = [
  {
    ...
    catgeory: "featured",
    title: "Tesla catches fire in Stamford, CT",
    authorName: "Gurprem Bhullar",
    authorImg: "../images/author.jpg",
    time: "5 Jun - 2022",
    desc: [
      {
        para1: "Tesla model 3 bursts into an intense flame that took 600 gallons per minute to extingish",
      },
      {
